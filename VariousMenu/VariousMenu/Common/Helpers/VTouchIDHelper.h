...
#define VNotice(Chinese,English) [[[[NSUserDefaults standardUserDefaults] objectForKey:@"AppleLanguages"] objectAtIndex:0] containsString:@"zh-Hans"] ? Chinese : English


@protocol VTouchIDDelegate <NSObject>
 ...
 */
- (void)VTouchIDAuthorizeErrorUserCancel;
 ...
 */
- (void)VTouchIDAuthorizeErrorUserFallback;
 ...
 */
- (void)VTouchIDAuthorizeErrorSystemCancel;
 ...
 */
- (void)VTouchIDAuthorizeErrorPasscodeNotSet;
 ...
 */
- (void)VTouchIDAuthorizeErrorTouchIDNotEnrolled;
 ...
 */
- (void)VTouchIDAuthorizeErrorTouchIDNotAvailable;
 ...
 *
 */
- (void)VTouchIDAuthorizeErrorTouchIDLockout;
 ...
 *
 */
- (void)VTouchIDAuthorizeErrorAppCancel;
 ...
 */
- (void)VTouchIDAuthorizeErrorInvalidContext;
 ...
 */
-(void)VTouchIDIsNotSupport;

@end

@interface VTouchIDHelper : NSObject


@property (nonatomic, weak) id<VTouchIDDelegate> delegate;
